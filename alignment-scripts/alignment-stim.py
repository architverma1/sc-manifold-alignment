...
dat_path = '/home/archithpc/data/alignment/stim.hdf5'
dat_file = h5py.File(dat_path,'r')
y_train = np.log2(1. + dat_file['counts'][:].T)
z_init = np.expand_dims(dat_file['z'][:],1)
...
'''e11_path = '/home/archithpc/data/katie-lung/E11/filtered_gene_bc_matrices_h5.h5'
e12_path = '/home/archithpc/data/katie-lung/E12/filtered_gene_bc_matrices_h5.h5'

e11 = h5py.File(e11_path, 'r')
e12 = h5py.File(e12_path, 'r')

e11_mat = csc_matrix((e11['mm10/data'],e11['mm10/indices'],e11['mm10/indptr']))
e12_mat = csc_matrix((e12['mm10/data'],e12['mm10/indices'],e12['mm10/indptr']))
from scipy.sparse import hstack
e11_nonblood = np.subtract(np.loadtxt('/home/archithpc/data/katie-lung/E11L_nonblood.txt').astype(np.int32),1)
e12_nonblood = np.subtract(np.loadtxt('/home/archithpc/data/katie-lung/E12L_nonblood.txt').astype(np.int32),1)
e11_mat = e11_mat[:,e11_nonblood]
e12_mat = e12_mat[:,e12_nonblood]

y_train = hstack((e11_mat,e12_mat)).T
'''
