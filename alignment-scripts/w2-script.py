...
latent_true = np.load('/home/archithpc/data/batch-effect-noise/latent_true.npy')
...
w2 = Parallel(n_jobs=num_cores)(delayed(w2)(i) for i in range(0,10))
#np.save('./w2-distance/' + init + iters, w2)

np.save('./w2-distance/pca', w2p)
#np.save('mnn', w2m)
#np.save('batch', w2b)
